...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Tag::create(['title' => 'bathroom']);
        Tag::create(['title' => 'beauty']);
        Tag::create(['title' => 'bedroom']);
        ...
        Tag::create(['title' => 'lighting']);
        Tag::create(['title' => 'lounge']);
