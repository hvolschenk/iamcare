...
* Users must be 13 years or older to give or take items.
* Users from The Netherlands may use all features of the platform.
* Browsing the site is open to everyone, but account creation is required to give or receive items.

## 2. User Accounts

* You are responsible for maintaining the confidentiality of your account.
* You agree to provide accurate information during registration and to keep it up to date.
* We reserve the right to suspend or terminate accounts if these terms or our policies are violated.
...
* We may change, remove, or add features to the service at any time without notice.
* We may suspend or terminate access to any user who breaches these Terms or our Privacy Policy.
...
For questions, concerns, or legal notices, contact us at: `privacy@iamcare.nl`.
EOD,
    'ZA' => <<<EOD
Last updated: 1 Jan 2025
...
* An account is required to give or receive items. Browsing is open to all users.
* You are responsible for the information you provide and for safeguarding your login details.
* We may suspend or terminate accounts for breach of these Terms or our Privacy Policy.

## 3. Acceptable Use

* You may only list legal items for free — selling is strictly prohibited.
* Content that is illegal, harmful, discriminatory, misleading, or offensive is not allowed.
* Users must treat others with respect and comply with all applicable South African laws.
...
* We may update, modify, or discontinue features of the service at any time, without notice.
* We reserve the right to remove content or suspend accounts that breach these Terms or applicable laws.
...
* Any disputes arising from these Terms will be resolved in accordance with South African law.

## 8. Privacy

* We comply with the Protection of Personal Information Act (POPIA).
* For details on how we handle your personal information, please refer to our Privacy Policy.

## 9. Contact

For questions or concerns, please contact our Information Officer:

`privacy@iamcare.nl`
Information Officer (South Africa): Hendrik Volschenk
EOD,
];
